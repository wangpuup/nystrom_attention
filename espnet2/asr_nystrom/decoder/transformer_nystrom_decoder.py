...
from espnet2.asr_nystrom.transformer.attention import MultiHeadedAttention
from espnet2.asr_nystrom.transformer.decoder_layer import NystromDecoderLayer
...
class NystromTransformerDecoder(BaseTransformerDecoder):
    def __init__(
        self,
        vocab_size: int,
        encoder_output_size: int,
        ...
        self.decoders = repeat(
            num_blocks,
            lambda lnum: NystromDecoderLayer(
                attention_dim,
